...
export const metadata: Metadata = {
  ...
  description: "DigiTalent este agenția de recrutare care conectează talentele cu companiile potrivite în toată România. Consiliere gratuită, joburi în digital, marketing și content creation.",
  ...
  openGraph: {
    ...
    description: "DigiTalent conectează talentele cu companiile potrivite în toată România. Consiliere gratuită, joburi în digital, marketing și content creation.",
